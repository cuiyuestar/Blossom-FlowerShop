 ...
 * 鲜花分页查询过滤器
 */
public interface FlowerQueryChainFilter<T extends FlowerPageQueryDTO> extends AbstractChainHandler<FlowerPageQueryDTO> {


    @Override
    default String mark() {
        return FlowerChainMarkEnum.FLOWER_QUERY_FILTER.name();
    }
}
